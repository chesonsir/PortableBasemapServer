...
";
        ...
        public Stream GenerateArcGISTile(string serviceName, string level, string row, string col)
        {
            ...
            if (Services.ContainsKey(serviceName))
            {
                //WebOperationContext.Current.IncomingRequest.Headers["Access-Control-Allow-Origin"] = "http://192.168.0.4";
                //WebOperationContext.Current.IncomingResponse.Headers["Access-Control-Allow-Origin"] = "http://192.168.0.4";
                ...
                //WebOperationContext.Current.OutgoingResponse.Headers["Access-Control-Allow-Methods"] = "GET, POST, PUT, DELETE";
                //WebOperationContext.Current.OutgoingResponse.Headers["Access-Control-Allow-Headers"] = "Content-Type, Accept";
                //WebOperationContext.Current.OutgoingResponse.Headers["Access-Control-Max-Age"] = "1728000";
